...
namespace SeniorDesign.Plugins.Filters
{
    ...
    /// </summary>
    [RenderIcon(Filename = "ButterworthHighPass1")]
    public class ButterworthHighPassFilter1 : DataFilter
    {
        ...
        /// </summary>
        public override string InternalName { get { return "Butterworth 1st Order High-Pass Filter"; } }
        ...
        /// </summary>
        public ButterworthHighPassFilter1(StreamlineCore core) : base(core) { }
