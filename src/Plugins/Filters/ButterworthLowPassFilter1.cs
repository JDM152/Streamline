...
namespace SeniorDesign.Plugins.Filters
{
    ...
    /// </summary>
    [RenderIcon(Filename = "ButterworthLowPass1")]
    public class ButterworthLowPassFilter1 : DataFilter
    {
        ...
        /// </summary>
        public override string InternalName { get { return "Butterworth 1st Order Low-Pass Filter"; } }
