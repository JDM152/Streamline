...
namespace SeniorDesign.Plugins.Filters
{
    ...
    /// </summary>
    [RenderIcon(Filename = "ButterworthLowPass2")]
    public class ButterworthLowPassFilter2 : DataFilter
    {
        ...
        /// </summary>
        public ButterworthLowPassFilter2(StreamlineCore core) : base(core) { }
