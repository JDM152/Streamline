...
{
    /// <summary>
    ///     A data filter that simulates a low-pass analog filter
    /// </summary>
    [RenderIcon(Filename = "LowPass")]
    public class LowPassFilter : DataFilter
    {
        ...
        /// </summary>
        public override string InternalName { get { return "Low-Pass Filter"; } }
