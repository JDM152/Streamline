...
namespace SeniorDesign.Plugins.Filters
{
    ...
    /// </summary>
    [RenderIcon(Filename = "Notch")]
    public class StopBandFilter : DataFilter
    {
        ...
        private void RecalcValues()
        {
            ...
            _b2 = (btop + 4 * _qualityFactor) / bottom;
            _b1 = (2 * btop - 8 * _qualityFactor) / bottom;
            _b0 = _b2;
        ...
        /// </summary>
        public override string InternalName { get { return "Stop-Band Filter"; } }
